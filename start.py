...
admin_email = input('[第1步/共10步]请输入管理员邮箱，用于接收推送邮件:')
print(admin_email)
print('')
admin_wechat_key = input('[第2步/共10步]请输入微信推送key(获取方法见: http://sc.ftqq.com/):')
print(admin_wechat_key)
print('')
weather_api_key = input('[第3步/共10步]请输入天气api的key(获取方法见: https://dev.heweather.com/):')
print(weather_api_key)
print('')
weather_default_location = input('[第4步/共10步]请输入您所在的位置，如："北京":')
print(weather_default_location)
print('')
mail_sender_address = input('[第5步/共10步]请输入用于发送的邮件地址:')
...
print('')
mysql_host = input('[第7步/共10步]请输入MySQL的地址，如"localhost"，端口将默认为3306，如需修改，见"backend\app\homepage.config":')
print(mysql_host)
print('')
...
print('')
redis_host = input('[第10步/共11步]请输入Redis的地址，如"localhost"，端口将默认为6379，如需修改，见"backend\app\homepage.config":')
print(redis_host)
print('')
